 ...
 * @author Pirozzi
 */
public class ControllerCRDTurnCOPIA implements ActionListener,KeyListener,MouseListener {
    
    ManagementTurnView view;
    ManagementTurnDao dao;
    int flag_errorDelete;
    
    public ControllerCRDTurnCOPIA( ManagementTurnDao dao , ManagementTurnView view )
    {
        this.view = view;
        this.dao = dao;
