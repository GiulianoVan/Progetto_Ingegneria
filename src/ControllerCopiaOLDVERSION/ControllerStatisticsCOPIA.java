...
import BusinessComponent.Controller.*;
 ...
 */
 /*
public class ControllerStatisticsCOPIA implements ActionListener,ItemListener{

    StatisticsView view;
    StatisticsDao dao;
    
 public ControllerStatisticsCOPIA(StatisticsDao dao,StatisticsView view)
 {
     this.dao = dao;
     this.view = view;
            ...
            if(view.getComboStatisticType().getSelectedItem().toString().equals("Distribution of the events and average age"))
            {
                Map<Comparable,Number> map = new HashMap<>();
                    ...
                    try {
                        ...
                        Logger.getLogger(ControllerStatisticsCOPIA.class.getName()).log(Level.SEVERE, null, ex);
                    }
            }
