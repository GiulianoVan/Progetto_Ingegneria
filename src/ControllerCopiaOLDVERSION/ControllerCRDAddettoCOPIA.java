 ...
 * @author Pirozzi
 */
public class ControllerCRDAddettoCOPIA extends BoundaryGeneralPanel{ //o estende la generale ?
//UTILIZZANDOLA QUANDO ESTENDE,BASTA USARE UN SOLO CONTROLLER,CONTROLLERADDETTO. IL COLLEGAMENTI COL PADRE VENGONO
    ...
    public ControllerCRDAddettoCOPIA(AddettoDao dao,AddettiPanel view)
    {
        super(view);
        this.dao = dao;
        this.view = view;
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        else if(action.equals("CREATE"))
        {
            ...
            salar = salar.replace(",", ".");
            //da qua in poi è compito del controller.
            Double salary = null;
            int errorSalary = 0;
...
*/
    public void doDeleteEvent(int rowCount) {
    ...
    public Set<Addetto> doAdvancedSearch(String cf, String name, String surname, Date from, Date to) {
        {
    ...
    public int createAddetto(String name, String surname, String username, String password, String code, Date birth, String phone, String email, Double salary) {
    ...
    public void doSearch(ArrayList<String> parolechiavi) {
