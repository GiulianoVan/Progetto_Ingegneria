 ...
 */
package BusinessComponent.Entity;
...
public class Event {
    ...
    public Event(String idEvent,String title, String description, String typeEvent, String typeGender, Date dataEvent, String placeName)
    {
