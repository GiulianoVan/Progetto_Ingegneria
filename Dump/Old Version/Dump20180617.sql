...
INSERT INTO `addsicurezza` VALUES (1,'CANON','TOMMI','tommasopirozzi@hotmail.it','TOMMASO','PIROZZI','PRZTMS92P04G309L','3343942027',6000,'2018-01-01'),(2,'MARCE','TOMMI','tom@hhhit','MARCELLO','QUATTROMANI','PRZTMS92P04G306L','3354548484',1500.5,'2018-01-01'),(3,'GIUL','TOMMI','tom@hhh.it','GIULIANO','VANESIO','PRZTMS92P04G305L','3405117062',1500.5,'2018-01-01'),(5,'prova','prova','vinc@hotmail.it','VINCENZO','TORINO','PRZTMS92P04G301P','0810000000',3000.15,'1992-06-19');
...
INSERT INTO `cliente` VALUES (4,'PROVA','yyy','TOMMASO','PIROZZI','TOM@XXX.ITF','PRZTMS92P04G309L','0810000000','1992-06-21',2),(5,'KEFMEKM','MEMKFK','GIULIANO','VANESIO','GIU@GG.IT','GRNVNS93D02F839M','0810000000','1993-04-17',0);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `cliente_BEFORE_UPDATE` BEFORE UPDATE ON `cliente` FOR EACH ROW BEGIN
    ...
    IF(OLD.ACQUISTI != NEW.ACQUISTI)
    THEN
       SIGNAL SQLSTATE '45006'
	   SET MESSAGE_TEXT = 'Error : That column is calculated,you cant update it ';
	END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
CREATE TABLE `evento` (
  ...
  `KIND_TYPE` enum('FOOTBALL','TENNIS','BASKET','VOLLEYBALL','SWIMMING','POP AND ROCK','METAL','MUSICAL','CABARET','COMEDY','DRAMATIC','HORROR','OTHER') DEFAULT NULL,
  `DATE` date NOT NULL,
...
INSERT INTO `evento` VALUES (1,'DA PAURA','BELLO E BUONO','CINEMA','HORROR','2017-12-05','80019','StadioQualiano'),(5,'BELLO','SUPER EVENTO','CINEMA','COMEDY','2018-06-18','80019','StadioQualiano'),(9,'A SPASSO NEL TEMPO','SUPER EVENTO','SPORT','FOOTBALL','2018-06-18','80019','StadioQualiano');
...
INSERT INTO `gestione_turno` VALUES (1,1,'00:00:00','00:00:00',5),(1,2,'00:00:00','00:00:00',6);
...
INSERT INTO `posto` VALUES ('Normal','1','C1'),('Normal','1','c2'),('Normal','1','c3');
...
INSERT INTO `reparto` VALUES ('Sala1','1','StadioQualiano','80019');
...
-- Dump completed on 2018-06-17 18:39:07
